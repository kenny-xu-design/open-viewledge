...
def run_pipeline(
    ...
    *,
    ...
    return {
        ...
        "transcript_fallback_reason": package.manifest.transcript_fallback_reason,
        "transcript_actual_provider": package.manifest.transcript_actual_provider,
        "transcript_actual_device": package.manifest.transcript_actual_device,
        "asr_worker_status": package.manifest.asr_worker_status,
        "worker_exitcode": package.manifest.worker_exitcode,
        "last_activity_at": package.manifest.last_activity_at,
        "last_heartbeat_at": package.manifest.last_heartbeat_at,
        "last_segment_at": package.manifest.last_segment_at,
        "last_segment_end": package.manifest.last_segment_end,
        "transcript_progress": package.manifest.transcript_progress,
